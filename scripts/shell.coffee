...
#
# Commands:
#   hubot spawn <command> = Spawns a subprocess and streams stdout back to chat.
#   hubot exec <command>  = Executes a subprocess and sends stdout upon completion.
#
# Author:
#  justmiles
